...
class GetGameStateAction
{
    ...
    public function execute(Room $room): GameStateData
    {
        ...
        // Otherwise use room's own game state (but return campaign data type)
     ...
     */
    public function executeForRoom(Room $room): \Domain\Room\Data\GameStateData
    {
        return \Domain\Room\Data\GameStateData::fromRoom($room);
    }
