...
class RoomWorkflowTest extends DuskTestCase
{
    use DatabaseMigrations;

    #[Test]
    public function user_can_complete_full_room_creation_workflow(): void
    {
    ...
    #[Test]
    public function user_can_copy_invite_link_and_view_room_details(): void
    {
    ...
    #[Test]
    public function second_user_can_join_room_via_invite_link(): void
    {
        $creator = User::factory()->create([
            'email' => 'creator@example.com',
            'password' => bcrypt('password'),
    ...
    #[Test]
    public function room_creator_can_start_session(): void
    {
        $creator = User::factory()->create([
            'email' => 'creator@example.com',
            'password' => bcrypt('password'),
    ...
    #[Test]
    public function user_can_leave_room_successfully(): void
    {
        $creator = User::factory()->create();
    ...
    #[Test]
    public function room_shows_participant_count_and_details(): void
    {
        $creator = User::factory()->create([
    ...
    #[Test]
    public function user_cannot_join_room_with_wrong_password(): void
    {
        $creator = User::factory()->create();
        $joiner = User::factory()->create([
            'email' => 'joiner@example.com',
    ...
    #[Test]
    public function room_dashboard_shows_created_and_joined_rooms(): void
    {
        $user = User::factory()->create([
    ...
    #[Test]
    public function session_page_loads_webrtc_functionality(): void
    {
        $user = User::factory()->create([
    ...
    #[Test]
    public function invalid_invite_code_shows_404(): void
    {
        $user = User::factory()->create([
            'email' => 'user@example.com',
            'password' => bcrypt('password'),
    ...
    #[Test]
    public function user_already_in_room_redirected_from_invite(): void
    {
        $user = User::factory()->create([
            'email' => 'user@example.com',
            'password' => bcrypt('password'),
    ...
    #[Test]
    public function room_capacity_enforcement_works(): void
    {
        $creator = User::factory()->create();
    ...
    #[Test]
    public function room_navigation_works_correctly(): void
    {
        $user = User::factory()->create([
