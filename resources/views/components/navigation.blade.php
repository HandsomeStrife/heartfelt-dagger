<nav class="bg-gradient-to-r from-slate-800 to-slate-900 border-b border-amber-500/30 p-4">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        <!-- Logo/Brand -->
        <div class="flex items-center space-x-3">
            <a href="/" class="flex items-center space-x-2">
                <img src="{{ asset('img/logo.png') }}" alt="Heartfelt Dagger Logo" class="w-auto h-8">
                <span class="font-federant text-2xl text-white tracking-wide">HeartfeltDagger</span>
            </a>
        </div>
        ...
        @auth
            <div class="relative" x-data="{ open: false }">
                ...
                >
                    ...
                    <span class="text-white/80 font-medium font-roboto">{{ auth()->user()->username }}</span>
                ...
                >
                    <div class="py-1">
                        ...
                        <a href="{{ route('campaigns') }}" class="flex items-center px-4 py-2 text-sm text-white/80 hover:bg-slate-700 hover:text-white transition-colors font-roboto">
        ...
        @else
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('register') }}" class="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-black font-bold py-2 px-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-amber-500/50 transform hover:scale-105 font-roboto">
                    Join Adventure
                </a>
            </div>
             -->
