    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-8">
                <!-- Desktop Navigation (Public Character Links) -->
                ...
                <div x-show="mobileMenuOpen" 
                    ...
                    <div class="py-2">
                        ...
                        @auth
                            ...
                            <a href="{{ route('campaigns') }}" class="flex items-center px-4 py-3 text-white/80 hover:bg-slate-700 hover:text-white transition-colors font-roboto border-b border-slate-600">
            ...
            @else
                <!-- Guest Navigation (Hidden as requested) -->
                <div class="flex items-center">
                    <!-- Auth links are hidden as requested -->
                </div>
            @endauth
