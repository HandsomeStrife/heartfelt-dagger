            ...
            <template x-for="[ancestryKey, ancestryData] in Object.entries(allAncestries)" :key="ancestryKey">
                ...
                >
                    ...
                    <div class="flex flex-col h-full">
                        <!-- Header -->
                        <div class="mb-4">
                            <h3 class="text-xl font-bold text-white font-outfit mb-2" x-text="ancestryData.name"></h3>
                            <p class="text-slate-300 text-sm line-clamp-3 leading-relaxed mb-3" x-text="ancestryData.description"></p>
                        </div>
    ...
    <template x-if="hasSelectedAncestry && selectedAncestryData">
        <div class="bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur border border-slate-700/50 rounded-2xl p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
                <div>
                    <h3 class="text-2xl font-bold text-white font-outfit mb-2" x-text="selectedAncestryData.name"></h3>
                    <p class="text-slate-300" x-text="selectedAncestryData.description"></p>
                </div>
                <button 
