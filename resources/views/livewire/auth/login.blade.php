<div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="bg-gradient-to-br from-slate-800 to-slate-900 border border-amber-500/30 rounded-lg p-8 shadow-2xl">
                <form wire:submit="login" class="space-y-6">
                    <div>
                        <label for="email" class="block text-sm font-medium text-white mb-2 font-roboto">Email</label>
                        <input 
                            type="email" 
                            id="email" 
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-white mb-2 font-roboto">Password</label>
                        <input 
                            type="password" 
                            id="password" 
                    ...
                    <div class="flex items-center">
                        <input 
                            ...
                            class="h-4 w-4 text-amber-400 bg-slate-700 border-slate-600 rounded focus:ring-amber-400"
                        >
                        <label for="remember" class="ml-2 text-sm text-white/70 font-roboto">Remember me</label>
                    </div>
