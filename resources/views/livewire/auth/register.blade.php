<div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800 flex items-center justify-center p-4" 
     x-data="{ 
         ...
         clearCharacterKeys() {
             ...
             console.log('Character keys cleared from localStorage after registration');
         }
     }" 
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="font-roboto text-white/70 text-sm">Join the Adventure</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-slate-800 to-slate-900 border border-amber-500/30 rounded-lg p-8 shadow-2xl">
            <form wire:submit="register" class="space-y-6">
                <div>
                    <label for="username" class="block text-sm font-medium text-white font-roboto mb-2">Username</label>
                    <input 
                        type="text" 
                        id="username" 
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-white font-roboto mb-2">Confirm Password</label>
                    <input 
                        type="password" 
