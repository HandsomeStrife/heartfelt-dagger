        ...
        <div class="bg-gradient-to-br from-slate-800 to-slate-900 border border-amber-500/30 rounded-lg p-8 shadow-2xl">
            @if ($email_sent)
                ...
                <div class="text-center space-y-4">
                    ...
                    <h3 class="text-xl font-bold text-white font-outfit">Email Sent!</h3>
                    <p class="text-white/70 text-sm font-roboto">
                        We've sent a password reset link to your email address. 
                        Check your inbox and follow the instructions to reset your password.
                    </p>
                    <p class="text-white/50 text-xs font-roboto">
                        Don't see the email? Check your spam folder or 
                        <button wire:click="$set('email_sent', false)" class="text-amber-400 hover:text-amber-300 underline">
                            try again
                        </button>
                    </p>
                </div>
            @else
                ...
                <form wire:submit="sendResetLink" class="space-y-6">
                    <div class="text-center mb-6">
                        <h2 class="text-2xl font-bold text-white font-outfit mb-2">Forgot Your Password?</h2>
                        <p class="text-white/70 text-sm font-roboto">
