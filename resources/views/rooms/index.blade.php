                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex items-center space-x-4 text-sm text-slate-500">
                                                    <span class="flex items-center">
                                                        ...
                                                        {{ $room->active_participant_count ?? 0 }}/{{ $room->guest_count }}
                                                    </span>
                                                    <span>Created {{ \Carbon\Carbon::parse($room->created_at)->diffForHumans() }}</span>
                                                </div>
                                            </div>
                                            <a href="{{ route('rooms.show', $room->id) }}" class="ml-4 text-emerald-400 hover:text-emerald-300 transition-colors">
                                ...
                                @foreach($joined_rooms as $room)
                                    <div class="bg-slate-800/50 border border-slate-600/50 rounded-xl p-4 hover:bg-slate-800/70 transition-colors">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <a href="{{ route('rooms.session', $room->id) }}" class="ml-4 text-blue-400 hover:text-blue-300 transition-colors">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
